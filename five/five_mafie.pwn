...
CMD:zwiaz(playerid,cmdtext[])
{
	...
	if(!NalezyDoDziZUp(playerid, DZIALALNOSC_MAFIE, 43))
	{
		return 0;
	}
	...
	{
		dShowPlayerDialog(playerid, DIALOG_INFO, DIALOG_STYLE_MSGBOX, "{88b711}» {FFFFFF}"VER" {88b711}» {FFFFFF}Informacja{88b711}:", "{DEDEDE}Aby {88b711}skuæ{DEDEDE} gracza wpisz: {88b711}/zwiaz [id gracza]", "Zamknij", "");
		return 1;
	}
	if(!PlayerObokPlayera(playerid, playerid2, 3))
	{
		dShowPlayerDialog(playerid, DIALOG_INFO, DIALOG_STYLE_MSGBOX, "{88b711}» {FFFFFF}"VER" {88b711}» {FFFFFF}Informacja{88b711}:", "{DEDEDE}Gracz którego chcesz {88b711}zwi¹zaæ{DEDEDE} jest zbyt daleko od ciebie.", "Zamknij", "");
		return 1;
	}
	...
	{
		dShowPlayerDialog(playerid, DIALOG_INFO, DIALOG_STYLE_MSGBOX, "{88b711}» {FFFFFF}"VER" {88b711}» {FFFFFF}Informacja{88b711}:", "{DEDEDE}Gracz którego próbujesz {88b711}zwi¹zaæ{DEDEDE} jest skuty!", "Zamknij", "");
		return 0;
	}
